...
- [imputnet/helium](https://github.com/imputnet/helium) ([0.15.1](https://github.com/imputnet/helium/releases/tag/0.15.1), 3 days ago) - Private, fast, and honest web browser
...
- [github/gh-stack](https://github.com/github/gh-stack) - GitHub Stacked PRs (5 days ago)
- [modem-dev/hunk](https://github.com/modem-dev/hunk) - Review-first terminal diff viewer for agentic coders (6 days ago)
- [kunchenguid/lavish-axi](https://github.com/kunchenguid/lavish-axi) - HTML is the new markdown. Lavish is the new editor for your HTML artifacts. (6 days ago)
