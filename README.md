...
- [conductor-oss/conductor](https://github.com/conductor-oss/conductor) ([v3.3.0.rc5](https://github.com/conductor-oss/conductor/releases/tag/v3.3.0.rc5), 2 days ago)
...
- [dmtrKovalenko/fff.nvim](https://github.com/dmtrKovalenko/fff.nvim) - The fastest and the most accurate file search toolkit for AI agents, Neovim, Rust, C, and NodeJS (2 weeks ago)
- [avivsinai/jenkins-cli](https://github.com/avivsinai/jenkins-cli) - GitHub-style CLI for Jenkins — manage contexts, runs, logs, and admin tasks from your terminal. (2 weeks ago)
- [BerriAI/litellm](https://github.com/BerriAI/litellm) - Python SDK, Proxy Server (AI Gateway) to call 100&#43; LLM APIs in OpenAI (or native) format, with cost tracking, guardrails, loadbalancing and logging. [Bedrock, Azure, OpenAI, VertexAI, Cohere, Anthropic, Sagemaker, HuggingFace, VLLM, NVIDIA NIM] (2 weeks ago)
- [poteto/noodle](https://github.com/poteto/noodle) - Orchestrate agents using skills (1 month ago)
- [nicobailon/visual-explainer](https://github.com/nicobailon/visual-explainer) - Agent skill that generates rich HTML pages or slide decks for diagrams, diff reviews, plan audits, data tables, and project recaps (1 month ago)
- [atilladeniz/Kubeli](https://github.com/atilladeniz/Kubeli) - A modern, native Kubernetes GUI management desktop app for macOS &amp; Windows. Multi-cluster support, real-time monitoring, AI assistant, terminal access, and more. (1 month ago)
