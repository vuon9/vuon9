...
- [imputnet/helium](https://github.com/imputnet/helium) ([0.15.5](https://github.com/imputnet/helium/releases/tag/0.15.5), 3 days ago) - Private, fast, and honest web browser
- [Sequel-Ace/Sequel-Ace](https://github.com/Sequel-Ace/Sequel-Ace) ([production/5.4.0-20109](https://github.com/Sequel-Ace/Sequel-Ace/releases/tag/production/5.4.0-20109), 5 days ago) - MySQL/MariaDB database management for macOS
...
- [xal-sh/xal](https://github.com/xal-sh/xal) - A terminal coding harness with a headless agent core (1 day ago)
- [nolight132/sonora](https://github.com/nolight132/sonora) - A native music streaming client, built with Rust and GPUI. (5 days ago)
