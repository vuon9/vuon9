...
- [conductor-oss/conductor](https://github.com/conductor-oss/conductor) ([v3.22.3](https://github.com/conductor-oss/conductor/releases/tag/v3.22.3), 2 days ago)
...
- [avivsinai/jenkins-cli](https://github.com/avivsinai/jenkins-cli) - GitHub-style CLI for Jenkins — manage contexts, runs, logs, and admin tasks from your terminal. (1 day ago)
