...
- [conductor-oss/conductor](https://github.com/conductor-oss/conductor) ([v3.22.0-beta](https://github.com/conductor-oss/conductor/releases/tag/v3.22.0-beta), 1 day ago)
...
- [zai-org/GLM-5](https://github.com/zai-org/GLM-5) - GLM-5: From Vibe Coding to Agentic Engineering (4 days ago)
- [samurmaykrr/zqlz](https://github.com/samurmaykrr/zqlz) - THE Editor. (4 days ago)
- [google-gemini/gemini-skills](https://github.com/google-gemini/gemini-skills) - Skills for the Gemini API, SDK and model/agent interactions (6 days ago)
