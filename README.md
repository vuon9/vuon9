...
- [fix: resolve 8 dependabot security alerts &#43; automated dependency management](https://github.com/vuon9/devtoolbox/pull/76) on [vuon9/devtoolbox](https://github.com/vuon9/devtoolbox) (6 days ago)
- [feat: dual-palette theme system with JSON themes &#43; user theme loading](https://github.com/vuon9/devtoolbox/pull/75) on [vuon9/devtoolbox](https://github.com/vuon9/devtoolbox) (6 days ago)
- [Respect bookmark-bar-ntp flag](https://github.com/imputnet/helium/pull/1639) on [imputnet/helium](https://github.com/imputnet/helium) (6 days ago)
- [chore(main): release 1.12.2](https://github.com/vuon9/youtube-listen-mode/pull/51) on [vuon9/youtube-listen-mode](https://github.com/vuon9/youtube-listen-mode) (6 days ago)
- [fix: scope channel name detection to video owner area](https://github.com/vuon9/youtube-listen-mode/pull/50) on [vuon9/youtube-listen-mode](https://github.com/vuon9/youtube-listen-mode) (6 days ago)

#### 🚀 Latest releases I've contributed to

- [imputnet/helium](https://github.com/imputnet/helium) ([0.12.3](https://github.com/imputnet/helium/releases/tag/0.12.3), 1 day ago) - Private, fast, and honest web browser
- [vuon9/youtube-listen-mode](https://github.com/vuon9/youtube-listen-mode) ([v1.12.2](https://github.com/vuon9/youtube-listen-mode/releases/tag/v1.12.2), 6 days ago) - Chrome extension that turns any YouTube video into audio‑only mode
...
- [imputnet/helium-macos](https://github.com/imputnet/helium-macos) - Helium Browser for macOS (6 days ago)
