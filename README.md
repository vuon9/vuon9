...
- [Fix editor-backed tool E2E flows](https://github.com/vuon9/devtoolbox/pull/100) on [vuon9/devtoolbox](https://github.com/vuon9/devtoolbox) (1 day ago)
- [fix: resolve 8 dependabot security alerts &#43; automated dependency management](https://github.com/vuon9/devtoolbox/pull/76) on [vuon9/devtoolbox](https://github.com/vuon9/devtoolbox) (1 week ago)
- [feat: dual-palette theme system with JSON themes &#43; user theme loading](https://github.com/vuon9/devtoolbox/pull/75) on [vuon9/devtoolbox](https://github.com/vuon9/devtoolbox) (1 week ago)
- [Respect bookmark-bar-ntp flag and also &#34;Always Show Bookmarks Bar&#34; menu option](https://github.com/imputnet/helium/pull/1639) on [imputnet/helium](https://github.com/imputnet/helium) (1 week ago)
- [chore(main): release 1.12.2](https://github.com/vuon9/youtube-listen-mode/pull/51) on [vuon9/youtube-listen-mode](https://github.com/vuon9/youtube-listen-mode) (1 week ago)

#### 🚀 Latest releases I've contributed to

- [conductor-oss/conductor](https://github.com/conductor-oss/conductor) ([v3.30.0](https://github.com/conductor-oss/conductor/releases/tag/v3.30.0), 1 day ago) - Conductor is an event driven agentic workflow engine providing durable and highly resilient execution engine for applications and AI Agents
- [vuon9/devtoolbox](https://github.com/vuon9/devtoolbox) ([v260521.1](https://github.com/vuon9/devtoolbox/releases/tag/v260521.1), 1 day ago) - Essential dev tools for daily tasks. Features are mostly completed, still buggy.
- [imputnet/helium](https://github.com/imputnet/helium) ([0.12.4](https://github.com/imputnet/helium/releases/tag/0.12.4), 2 days ago) - Private, fast, and honest web browser
...
- [TableProApp/TablePro](https://github.com/TableProApp/TablePro) - Free and open source database client built natively for developers (6 days ago)
