...
- [Sequel-Ace/Sequel-Ace](https://github.com/Sequel-Ace/Sequel-Ace) ([beta/5.5.0-20110](https://github.com/Sequel-Ace/Sequel-Ace/releases/tag/beta/5.5.0-20110), 1 day ago) - MySQL/MariaDB database management for macOS
- [imputnet/helium](https://github.com/imputnet/helium) ([0.15.6](https://github.com/imputnet/helium/releases/tag/0.15.6), 2 days ago) - Private, fast, and honest web browser
...
- [anywhere-labs/deepseek-harness-desktop](https://github.com/anywhere-labs/deepseek-harness-desktop) - 为 DeepSeek Harness (DSH) 插件生态打造的现代化桌面端解决方案。万物皆「插件」，桌面本身也是「插件」。 (2 days ago)
- [xal-sh/xal](https://github.com/xal-sh/xal) - A terminal coding harness with a headless agent core (4 days ago)
