...
- [imputnet/helium](https://github.com/imputnet/helium) ([0.18.1](https://github.com/imputnet/helium/releases/tag/0.18.1), 3 days ago) - Private, fast, and honest web browser
- [Sequel-Ace/Sequel-Ace](https://github.com/Sequel-Ace/Sequel-Ace) ([production/6.0.1-20114](https://github.com/Sequel-Ace/Sequel-Ace/releases/tag/production/6.0.1-20114), 5 days ago) - MySQL/MariaDB database management for macOS
...
- [sdras/jev-webmcp-extension](https://github.com/sdras/jev-webmcp-extension) - A small extension that demos the combination of Jev x WebMCP (4 days ago)
- [acsandmann/rift](https://github.com/acsandmann/rift) - a tiling window manager for macos (5 days ago)
- [eaze/eaze-tests](https://github.com/eaze/eaze-tests) -  (1 week ago)
