...
- [vuon9/onyx](https://github.com/vuon9/onyx) - Static website from an experience with GLM 5.2 model (3 months ago)

#### 🚀 Latest releases I've contributed to

- [Sequel-Ace/Sequel-Ace](https://github.com/Sequel-Ace/Sequel-Ace) ([production/6.0.1-20114](https://github.com/Sequel-Ace/Sequel-Ace/releases/tag/production/6.0.1-20114), 2 days ago) - MySQL/MariaDB database management for macOS
- [vuon9/gh-workflows](https://github.com/vuon9/gh-workflows) ([v0.4.2](https://github.com/vuon9/gh-workflows/releases/tag/v0.4.2), 5 days ago) - Reusable GitHub workflows
- [imputnet/helium](https://github.com/imputnet/helium) ([0.17.2](https://github.com/imputnet/helium/releases/tag/0.17.2), 6 days ago) - Private, fast, and honest web browser
...
- [sdras/jev-webmcp-extension](https://github.com/sdras/jev-webmcp-extension) - A small extension that demos the combination of Jev x WebMCP (1 day ago)
- [acsandmann/rift](https://github.com/acsandmann/rift) - a tiling window manager for macos (2 days ago)
- [eaze/eaze-tests](https://github.com/eaze/eaze-tests) -  (4 days ago)
