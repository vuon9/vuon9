...
- [conductor-oss/conductor](https://github.com/conductor-oss/conductor) ([v3.22.3](https://github.com/conductor-oss/conductor/releases/tag/v3.22.3), 3 days ago)
...
- [avivsinai/jenkins-cli](https://github.com/avivsinai/jenkins-cli) - GitHub-style CLI for Jenkins — manage contexts, runs, logs, and admin tasks from your terminal. (2 days ago)
- [BerriAI/litellm](https://github.com/BerriAI/litellm) - Python SDK, Proxy Server (AI Gateway) to call 100&#43; LLM APIs in OpenAI (or native) format, with cost tracking, guardrails, loadbalancing and logging. [Bedrock, Azure, OpenAI, VertexAI, Cohere, Anthropic, Sagemaker, HuggingFace, VLLM, NVIDIA NIM] (3 days ago)
...
- [trishume/syntect](https://github.com/trishume/syntect) - Rust library for syntax highlighting using Sublime Text syntax definitions. (4 weeks ago)
