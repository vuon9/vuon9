...
- [vuon9/dotfiles](https://github.com/vuon9/dotfiles) - My dotfiles (4 days ago)
...
- [vuon9/devtoolbox](https://github.com/vuon9/devtoolbox) ([v0.9.4](https://github.com/vuon9/devtoolbox/releases/tag/v0.9.4), 2 days ago)
...
- [philschmid/mcp-cli](https://github.com/philschmid/mcp-cli) - Lighweight CLI to interact with MCP servers (1 day ago)
- [browser-use/browser-use](https://github.com/browser-use/browser-use) - 🌐 Make websites accessible for AI agents. Automate tasks online with ease. (1 day ago)
- [alienator88/Pearcleaner](https://github.com/alienator88/Pearcleaner) - A free, source-available and fair-code licensed mac app cleaner (2 days ago)
- [matryer/is](https://github.com/matryer/is) - Professional lightweight testing mini-framework for Go. (3 days ago)
- [matryer/xbar-plugins](https://github.com/matryer/xbar-plugins) - Plugin repository for xbar (the BitBar reboot) (3 days ago)
