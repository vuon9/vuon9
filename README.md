...
- [vuon9/onyx](https://github.com/vuon9/onyx) - Static website from an experience with GLM 5.2 model (4 days ago)
...
- [vuon9/vuon9.github.io](https://github.com/vuon9/vuon9.github.io) - Public support pages for my released apps (1 week ago)
...
- [imputnet/helium](https://github.com/imputnet/helium) ([0.13.6](https://github.com/imputnet/helium/releases/tag/0.13.6), 3 days ago) - Private, fast, and honest web browser
- [vuon9/devtoolbox](https://github.com/vuon9/devtoolbox) ([v0.10.0-rc.3](https://github.com/vuon9/devtoolbox/releases/tag/v0.10.0-rc.3), 1 week ago) - Essential dev tools for daily tasks. Features are mostly completed, still buggy.
- [Sequel-Ace/Sequel-Ace](https://github.com/Sequel-Ace/Sequel-Ace) ([beta/5.3.0-20101](https://github.com/Sequel-Ace/Sequel-Ace/releases/tag/beta/5.3.0-20101), 3 weeks ago) - MySQL/MariaDB database management for macOS
...
- [Cuimao777/eterna-image2image-skill](https://github.com/Cuimao777/eterna-image2image-skill) - Experimental bilingual Codex skill for ETERNA-inspired image2image cinematic color and composition. (2 days ago)
- [abundantbeing/hermes-browser-extension](https://github.com/abundantbeing/hermes-browser-extension) - Browser-native side panel for Hermes Agent — connect web context to your local Hermes runtime. (3 days ago)
