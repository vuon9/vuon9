...
- [vuon9/youtube-listen-mode](https://github.com/vuon9/youtube-listen-mode) ([v1.11.2](https://github.com/vuon9/youtube-listen-mode/releases/tag/v1.11.2), 1 day ago)
- [conductor-oss/conductor](https://github.com/conductor-oss/conductor) ([v3.22.3](https://github.com/conductor-oss/conductor/releases/tag/v3.22.3), 5 days ago)
...
- [dmtrKovalenko/fff.nvim](https://github.com/dmtrKovalenko/fff.nvim) - The fastest and the most accurate file search toolkit for AI agents, Neovim, Rust, C, and NodeJS (2 days ago)
- [avivsinai/jenkins-cli](https://github.com/avivsinai/jenkins-cli) - GitHub-style CLI for Jenkins — manage contexts, runs, logs, and admin tasks from your terminal. (4 days ago)
- [BerriAI/litellm](https://github.com/BerriAI/litellm) - Python SDK, Proxy Server (AI Gateway) to call 100&#43; LLM APIs in OpenAI (or native) format, with cost tracking, guardrails, loadbalancing and logging. [Bedrock, Azure, OpenAI, VertexAI, Cohere, Anthropic, Sagemaker, HuggingFace, VLLM, NVIDIA NIM] (5 days ago)
