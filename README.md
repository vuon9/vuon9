...
- [imputnet/helium](https://github.com/imputnet/helium) ([0.15.5](https://github.com/imputnet/helium/releases/tag/0.15.5), 1 day ago) - Private, fast, and honest web browser
- [Sequel-Ace/Sequel-Ace](https://github.com/Sequel-Ace/Sequel-Ace) ([production/5.4.0-20109](https://github.com/Sequel-Ace/Sequel-Ace/releases/tag/production/5.4.0-20109), 3 days ago) - MySQL/MariaDB database management for macOS
...
- [nolight132/sonora](https://github.com/nolight132/sonora) - A native music streaming client, built with Rust and GPUI. (3 days ago)
...
- [kunchenguid/lavish-axi](https://github.com/kunchenguid/lavish-axi) - HTML is the new markdown. Lavish is the new editor for your HTML artifacts. (2 weeks ago)
